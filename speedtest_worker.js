...
let clientIp = '' // client's IP address as reported by /api/ip
...
let settings = {
  ...
  url_dl: 'api/download', // path to download endpoint, used for download test. must be relative to this js file
  url_ul: 'api/upload', // path to upload endpoint, used for upload test. must be relative to this js file
  url_ping: 'api/ping', // path to ping endpoint, used for ping test. must be relative to this js file
  url_getIp: 'api/ip', // path to IP endpoint relative to this js file, or a similar thing that outputs the client's ip
  ...
  garbagePhp_chunkSize: 100, // size of chunks sent by download endpoint (can be different if enable_quirks is active)
  ...
  url_telemetry: 'api/telemetry', // path to the script that adds telemetry data to the database
